        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <ScrollReveal delay={0.2}>
            <SpotlightCard className="p-8 h-full text-center hover:border-emerald-500/30 transition-colors">
              ...
              <h3 className="text-white font-bold uppercase text-xs tracking-widest mb-2">WhatsApp Business</h3>
              <p className="text-xs text-slate-500">Rich media messaging and automated bots.</p>
            </SpotlightCard>
          </ScrollReveal>
          ...
          <ScrollReveal delay={0.3}>
            <SpotlightCard className="p-8 h-full text-center hover:border-emerald-500/30 transition-colors">
              ...
              <h3 className="text-white font-bold uppercase text-xs tracking-widest mb-2">Email API</h3>
