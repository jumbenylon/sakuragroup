...
// --- ANIMATED CHAT COMPONENT (The "WhatsApp" Feel) ---
const AnimatedChat = () => {
  ...
  return (
    <div ref={ref} className="w-full max-w-sm mx-auto bg-[#0b141a] border border-white/10 rounded-xl overflow-hidden shadow-2xl relative">
      ...
      {/* Background Pattern */}
      <div className="p-4 space-y-4 h-[300px] bg-[url('https://user-images.githubusercontent.com/15075759/28719144-86dc0f70-73b1-11e7-911d-60d70fcded21.png')] bg-opacity-5 relative">
        <div className="absolute inset-0 bg-[#0b141a]/90 z-0" /> {/* Dark overlay for chat bg */}
...
const AxisSubNav = () => {
  ...
  return (
    <motion.nav
      ...
      className="fixed top-16 w-full z-[90] bg-[#020617]/80 backdrop-blur-xl border-b border-white/5 h-12 flex items-center pointer-events-none lg:pointer-events-auto"
    >
      <div className="max-w-7xl mx-auto w-full px-8 flex justify-between items-center">
        ...
        <div className="flex gap-8">
          {["Why", "WhatsApp", "SMS", "Pricing"].map(item => (
            <a key={item} href={`#${item.toLowerCase()}`} className="text-[9px] font-bold uppercase tracking-widest text-white/40 hover:text-emerald-400 transition-colors pointer-events-auto">
              {item}
            </a>
          ))}
        </div>
...
export default function AxisPage() {
  return (
    ...
    <main className="bg-[#020617] text-white selection:bg-emerald-500 font-sans">
      <GlobalNavbar />
      <AxisSubNav />

      {/* 1. HERO SECTION: NAVY DEEP DIVE */}
      <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-6 pt-32 pb-20 overflow-hidden">
        ...
        <div className="max-w-5xl z-10 space-y-8 relative">
          <motion.div 
          ...
          >
            Talk to your<br/>
            <span className="text-transparent bg-clip-text bg-gradient-to-b from-white to-slate-400">customers.</span>
          </motion.h1>
          ...
          >
            <Link href="/contact" className="px-10 py-5 bg-white text-black font-black text-xs uppercase tracking-[0.2em] hover:bg-emerald-500 hover:text-white transition-all shadow-[0_0_40px_-10px_rgba(16,185,129,0.3)]">
              Request Access
            </Link>
        ...
        <div className="absolute bottom-12 w-full overflow-hidden">
          ...
          <div className="flex justify-center gap-12 opacity-30 grayscale hover:grayscale-0 transition-all duration-700">
            {[Building2, GraduationCap, TruckIcon, ShieldCheck].map((Icon, i) => (
              <Icon key={i} size={32} className="text-emerald-500" />
            ))}
          </div>
        </div>
      </section>
      ...
      {/* 2. WHY AXIS (CONTEXT) */}
      <section id="why" className="py-32 px-6 border-y border-white/5 bg-[#0b1121]">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
          <div className="space-y-8">
            <h2 className="text-4xl md:text-5xl font-black uppercase italic leading-none text-white">
              Why Axis Exists.
            </h2>
          ...
          <div className="relative h-[500px] w-full bg-white/5 rounded-sm overflow-hidden border border-white/10">
             ...
             />
             <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-[#0b1121] to-transparent">
      ...
      {/* 3. WHATSAPP SECTION (WhatsApp Brand Colors) */}
      <section id="whatsapp" className="py-32 px-6 bg-[#020617] relative overflow-hidden">
        {/* WhatsApp Green Glow */}
          ...
          <div className="order-1 lg:order-2 space-y-8">
            ...
            <div className="grid sm:grid-cols-2 gap-4 pt-4">
              {[
                ...
                <div key={i} className="p-4 border border-white/10 bg-[#0f172a] rounded-sm text-xs font-mono uppercase tracking-widest text-emerald-400/80">
                  {useCase}
                </div>
              ))}
            </div>
      ...
      {/* 4. SMS SECTION (Tech Blue/Navy) */}
      <section id="sms" className="py-32 px-6 border-t border-white/5 bg-[#0b1121]">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end gap-12 mb-20">
            ...
            <div className="bg-[#0f172a] border border-white/10 p-8 min-w-[300px] text-center shadow-2xl">
      ...
      {/* 5. HOW IT WORKS */}
      <section id="how-it-works" className="py-32 px-6 bg-[#020617] border-t border-white/5">
        <div className="max-w-7xl mx-auto text-center mb-20">
           <h2 className="text-3xl md:text-4xl font-black uppercase tracking-widest mb-4">Integration Protocol</h2>
           <p className="text-emerald-500/60 font-mono text-xs uppercase tracking-widest">Three steps to live transmission</p>
        </div>

        <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-12 relative">
          <div className="absolute top-12 left-0 w-full h-px bg-gradient-to-r from-transparent via-emerald-500/20 to-transparent hidden md:block" />
          ...
          {[
            ...
            <div key={i} className="relative bg-[#020617] p-6 text-center group">
              <div className="w-24 h-24 mx-auto bg-[#0b1121] border border-white/10 rounded-full flex items-center justify-center mb-8 relative z-10 group-hover:border-emerald-500 transition-colors">
      ...
      {/* 6. CONVERSION BLOCK (Navy/Teal Gradient) */}
      <section className="py-40 bg-gradient-to-br from-[#0f172a] to-[#002c2b] text-white text-center px-6 relative overflow-hidden">
...
function SectorCard({ icon, title, desc }: any) {
  return (
    <div className="p-8 bg-white/[0.02] border border-white/5 hover:bg-white/[0.05] hover:border-emerald-500/30 transition-all group">
