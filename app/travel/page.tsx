    ...
    <div className="bg-[#02040a] min-h-screen selection:bg-violet-500">
      ...
      <section className="py-24 px-6 border-y border-white/5">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-2xl md:text-4xl font-light leading-tight text-white italic">"Travel is the ultimate expression of sovereignty. We provide the infrastructure; you provide the destination."</p>
        </div>
      </section>
      <ExperienceGrid />
    </div>
